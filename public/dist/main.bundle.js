...
module.exports = "\n\n\n<head><script src=\"https://cdnjs.cloudflare.com/ajax/libs/ng2-bootstrap/x.x.x/ng2-bootstrap.min.js\"></script>\n   <link href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css\" rel=\"stylesheet\"></head>\n\n\n<div class='container redBorder'>\n  <h1>Anonymous Notes</h1>\n  <form #form=\"ngForm\" (submit)=\"onSubmit(note)\">\n    <p>Note: <input type=\"text\" name=\"note_form\"\n    required\n    minlength=\"3\"\n    [(ngModel)]=\"note.note\"\n    #noteModel='ngModel'>\n    </p>\n    \n    \n    <input [disabled]=\"!form.valid\" type=\"submit\" value=\"Add note\">\n  </form>\n<div class='noteList'>\n  <app-note-list></app-note-list>\n</div>\n</div>\n\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onSubmit = function (note) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__note_list_note_list_component__ = __webpack_require__("../../../../../src/app/note-list/note-list.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__note_list_note_list_component__["a" /* NoteListComponent */]
        ],
        imports: [
...
var HttpService = (function () {
    ...
    HttpService.prototype.retrieve = function () {
...
module.exports = "<div *ngFor='let note of notes' class='container blueBorder'>\n\n<div>{{note.note}}</div> <div>Noted on: {{note.createdAt | date: 'medium'}}</div>\n\n</div>"
